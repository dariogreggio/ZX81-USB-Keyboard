 ...
 * File Description:
 * 
 * This file defines primitive operations and data structures that provide
 ...
 *          }
 *
 *      The ISR sequence generally does not need to be guarded since it 
 ...
 *      more of the other primitives to ensure that the queue has an item
 *      to remove.
 *
 *      A particular type of queue may only contain one type of item 
 *      unless a union type is used for the queue's buffer array.
 *
 *      The struct-queue primitive operations are defined as typeless 
